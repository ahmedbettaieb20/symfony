 ...
 */
final class Version20231016220719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD author_id INT DEFAULT NULL, CHANGE ref ref VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP author_id, CHANGE ref ref INT AUTO_INCREMENT NOT NULL');
    }
}
